...
function correctContent()
{
	...
	if(theWebUI.systemInfo.rTorrent.iVersion>=0x904)	
	{
		$.extend(theRequestManager.aliases, 
		{
			"create_link"		:	{ name: "d.create_link", prm: 1 },
			...
			"d.set_directory"	:	{ name: "d.directory.set", prm: 1 },
			"d.set_directory_base"	:	{ name: "d.directory_base.set", prm: 1 },
			"d.set_hashing_failed"	:	{ name: "d.hashing_failed.set", prm: 1 },
			"d.set_ignore_commands"	:	{ name: "d.ignore_commands.set", prm: 1 },
			"d.set_max_file_size"	:	{ name: "d.max_file_size.set", prm: 1 },
			"d.set_message"		:	{ name: "d.message.set", prm: 1 },
			"d.set_peers_max"	:	{ name: "d.peers_max.set", prm: 0 },
			"d.set_peers_min"	:	{ name: "d.peers_min.set", prm: 0 },
			"d.set_priority"	:	{ name: "d.priority.set", prm: 1 },
			"d.set_throttle_name"	:	{ name: "d.throttle_name.set", prm: 1 },
			"d.set_tied_to_file"	:	{ name: "d.tied_to_file.set", prm: 1 },
			...
			"t.set_enabled"		:	{ name: "t.is_enabled.set", prm: 1 },
			...
			"delete_link"		:	{ name: "d.delete_link", prm: 1 },
