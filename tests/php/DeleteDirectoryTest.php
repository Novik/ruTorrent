...
class DeleteDirectoryTest extends TestCase
{
    ...
    {
        $dir = $this->make('flat', ['a.txt' => 'a', 'b.txt' => 'b']);
    ...
    {
        $dir = $this->make('nested-empty', ['sub' => null]);
    ...
    {
        $dir = $this->make('ordering-reversed', [
            'a-dir/leaf.txt' => 'leaf',
            'z-file.txt' => 'z',
        ]);
        $this->deleteAndReport($dir);
    ...
    {
        $dir = $this->make('trailing', ['sub/leaf.txt' => 'leaf']);
