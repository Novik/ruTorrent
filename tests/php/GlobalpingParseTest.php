...
class GlobalpingParseTest extends TestCase
{
    ...
    public function testAPortThatRepliesIsOpen()
    {
        $this->assertEquals(
            2,
            check_port_parse_globalping($this->replied()),
    ...
    {
        $this->assertTrue(
            strpos($this->silent(), 'tcp_conn=') !== false,
            'the no-reply output does carry the attempt counter',
        );
        $this->assertEquals(
            0,
            check_port_parse_globalping($this->silent()),
    ...
    {
        $this->assertTrue(
            check_port_parse_globalping($this->silent()) !== 1,
    ...
    public function testAnExplicitRefusalIsClosed()
    {
        ...
        $this->assertEquals(
            1,
            check_port_parse_globalping($raw),
    ...
    public function testAnEmptyOrAbsentOutputIsUnknown()
    {
        ...
        $this->assertEquals(
            0,
            check_port_parse_globalping(false),
    ...
    public function testOutputInAnUnfamiliarShapeIsUnknown()
    {
        $this->assertEquals(
            0,
            check_port_parse_globalping("something Globalping has never printed\n"),
