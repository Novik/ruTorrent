...
class TorrentAddPathSequenceTest extends TestCase
{
    ...
    public function testFastResumeBuildsResumeDataOnATorrentThatHasNone()
    {
        ...
        $expected = $this->bdict([
            ...
            'libtorrent_resume' => $this->expectedResume(1, ['test.data']),
        ]);
        $this->assertTrue(
            (string) $torrent === $expected,
    ...
    public function testFastResumeWritesOneEntryPerFileWithTheAddPathPrefix()
    {
        ...
        $expected = $this->bdict([
            ...
            'libtorrent_resume' => $this->expectedResume(
                1,
                ['payload/one.data', 'payload/sub/two.data'],
            ),
        ]);
        $this->assertTrue(
            (string) $torrent === $expected,
    ...
    public function testFastResumeRefusesWhenAFileIsNotWhereItWouldBe()
    {
        ...
        $this->assertTrue(
            strpos((string) $torrent, $this->bstr('info')) !== false,
    ...
    public function testFastResumeOverwritesTheResumeDataASessionTorrentCameWith()
    {
        ...
        $this->assertTrue(
            $torrent->libtorrent_resume['files'][0]['mtime'] == 1234567891,
