...
if($needStart)
{
	...
	$req = new rXMLRPCRequest( new rXMLRPCCommand("schedule", array('rss'.getUser(),$startAt."",$interval."",'execute={sh,-c,'.getPHP().' '.$rootPath.'/plugins/rss/update.php '.getUser().' & exit 0}')) );
