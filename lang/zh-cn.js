...
var theUILang =
{
 ...
 badXMLRPCVersion		: "rTorrent 编译时用的 xmlrpc-c 库版本不对, 此版本没有 i8 支持. 版本必须 >= 1.11. 某些功能将不可用.",
 badLinkTorTorrent		: "无法连接到 rTorrent. 检查它是否真正在运行.  检查 config.php 中的 $scgi_port 和 $scgi_host 设置, 以及 rTorrent 中的 scgi_port 设置.",
 badUploadsPath 		: "网页服务器执行用户对 torrents 存放文件夹 没有 读/写/执行 权限. 你将无法从 ruTorrent 添加 torrents.",
 badSettingsPath		: "网页服务器执行用户对配置存储文件夹没有 读/写/执行 权限. ruTorrent 设置无法被保存.",
 mnu_help			: "关于",
 badUploadsPath2		: "rTorrent 执行用户 必须对 torrents 存放文件夹有 读/写 权限. 你将无法从 ruTorrent 添加 torrents.",
 View				: "查看",
 AsList 			: "为列表",
 AsTree 			: "为树状",
 Group				: "组",
 ...
 badSettingsPath2		: "rTorrent 执行用户 必须对配置存放文件夹有 读/写/执行 权限",
 scrapeDownloaded		: "已下载",
 Total				: "总计",
 PCRENotFound			: "PHP PCRE 模块未安装. ruTorrent 将不会工作.",
 addTorrentSuccess		: "成功添加 torrent.",
 ...
 idNotFound			: "rTorrent 执行用户不能访问 'id' 程序. 某些功能将不可用.",
 gzipNotFound			: "Webserver 执行用户不能访问 'gzip' 程序. ruTorrent 将不会工作.",
 cantObtainUser 		: "ruTorrent 不能确定 rTorrent 执行用户的 UID . 某些功能将不可用.",
 retryOnErrorTitle		: "如果 rTorrent 不可用则在这个时间后重试",
 retryOnErrorList		: { 0: "不重试", 30: "30 秒", 60: "1 分钟", 120: "2 分钟", 300: "5 分钟", 900: "15 分钟" },
 statNotFound			: "rTorrent 执行用户不能访问 'stat' 程序. 某些功能将不可用.",
 statNotFoundW			: "网页服务器执行用户不能访问 'stat' 程序. 某些功能将不可用.",
 badrTorrentVersion		: "插件要求 rTorrent 版本 >=",
 badPHPVersion			: "插件要求 PHP 版本 >=",
 rTorrentExternalNotFoundError	: "插件将不会工作. rTorrent 执行用户不能访问外部程序",
 rTorrentExternalNotFoundWarning: "某些功能将不可用. rTorrent 执行用户不能访问外部程序",
 webExternalNotFoundError	: "插件将不会工作. 网页服务器执行用户不能访问外部程序",
 webExternalNotFoundWarning	: "某些功能将不可用. 网页服务器执行用户不能访问外部程序",
 rTorrentBadScriptPath		: "插件将不会工作. rTorrent 执行用户必须对文件有 读/执行 权限",
 rTorrentBadPHPScriptPath	: "插件将不会工作. rTorrent 必须对文件有访问权限",
 ...
 noTorrentList			: "Torrent 列表尚不可用, 到 rTorrent 的连接未建立.",
 yes				: "yes",
 no				: "no",
 DateFormat			: "日期格式",
 DLStrategy			: "下载策略",
 ...
 trkPrivate			: "私有",
 dontSet			: "不要设置",
 webBadSessionError		: "插件将不会工作. 网页服务器执行用户必须对 rTorrent 的 session 文件夹有 执行 权限",
 webBadSessionWarning		: "某些功能将不可用. 网页服务器执行用户必须对 rTorrent 的 session 文件夹有 执行 权限",
 Developers			: "开发者",
 ...
 badTempPath 			: "网页服务器执行用户对 tmp(临时) 文件夹没有 读/写/执行 权限. ruTorrent 将不会工作.",
 badTempPath2			: "rTorrent 执行用户必须对 tmp(临时) 文件夹有 读/执行 权限. ruTorrent 将不会工作.",
