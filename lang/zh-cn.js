...
var theUILang =
{
 ...
 gzipNotFound			: "网页服务器 执行用户不能访问 'gzip' 程序. ruTorrent 将不会工作.",
 ...
 badTempPath 			: "网页服务器执行用户对 tmp 文件夹没有 读/写/执行 权限. ruTorrent 将不会工作.",
 badTempPath2			: "rTorrent 执行用户必须对 tmp 文件夹有 读/执行 权限. ruTorrent 将不会工作.",
