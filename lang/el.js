...
var theUILang =
{
 ...
 KeepSelectedTab			: "Διατήρηση επιλεγμένης καρτέλας",
 KeepSelectedLabels		: "Διατήρηση επιλεγμένων ετικετών",
 ...
 Torrent_URL_multiline		: "URL των Torrent (ένα ανά γραμμή)",
 ...
 Torrent_options		: "Επιλογές για το Torrent",
 Return_select_label		: "Επιλογή",
 Add_from_file			: "Προσθήκη από Αρχείο",
 ...
 SaveCurrentView		: "Αποθήκευση τρέχουσας προβολής",
 showViewPanel			: "Εμφάνιση Πίνακα Προβολών",
 showViewLabelSize		: "Εμφάνιση μεγέθους ετικέτας στον Πίνακα Προβολών",
 pnlState			: "Κατάσταση",
 ...
 innerSearch			: "Τοπικά αρχεία Torrent",
 ...
 DecimalPlacesSizes		: "Θέσεις Δεκαδικών στα Μεγέθη",
 CatListSizeDecimalPlaces	: "Στη λίστα κατηγοριών",
 TableSizeDecimalPlaces	: "Στους πίνακες",
 DetailsSizeDecimalPlaces	: "Στην καρτέλα γενικά",
 OtherSizeDecimalPlaces	: "Άλλο",
 Default	: "Προεπιλογή",
 ...
 showStateLabelSize		: "Προβολή μεγέθους στην κατάσταση",
 ...
 labelSizeRightAlign		: "Δεξιά στοίχιση του μεγέθους στη λίστα κατηγοριών",
 ...
 Original_webui			: "Προτότυπο WebUI του µTorrent",
 rTorrent_adaption		: "Προσαρμογή για το rTorrent (ruTorrent)",
