...
class KinozalCheckImpl
{
    ...
    public const GUEST_MARKER = '/signup.php';
    ...
    public const MISSING_MARKER = 'Торрент файл не найден';
    ...
    public const GUEST_TOLERANCE = 2;

    private static $guestAnswers = 0;
    ...
    private static function bodyHas($body, $needle)
    {
        ...
        if (function_exists('iconv')) {
            ...
            if (is_string($legacy) && $legacy !== '' && strpos($body, $legacy) !== false) {
                return true;
            }
        }
        return false;
    ...
    private static function isGuestAnswer($body)
    {
    ...
    // validates in.
    private static function isMetainfo($payload)
    {
    ...
    private static function cantReach($log)
    {
    ...
    private static function guestAnswer($log)
    {
