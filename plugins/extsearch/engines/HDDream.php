...
{
       	public $defaults = array( "public"=>false, "page_size"=>15, "cookies"=>"hd-dream.net|c_secure_uid=XXX;c_secure_pass=XXX;" );
	...
	public function action($what,$cat,&$ret,$limit,$useGlobalCats)
	{
		...
		for($pg = 1; $pg<10; $pg++)
		{
			...
			$res = preg_match_all('/<a href="http:\/\/hd-dream\.net\/browse\.php\?browse_categories&amp;category=\d+" target="_self" /><img src.*alt=".*: (?P<cat>.*)".*'.
