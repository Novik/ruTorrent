...
{
    public $defaults = [ "public" => false, "page_size" => 50, "cookies" => "www.demonoid.com|uhsh=XXX;uid=XXX" ];
    public $categories = [ 'all' => '0', 'Anime' => '9', 'Applications' => '5', 'Audio Books' => '17', 'Books' => '11', 'Comics' => '10',
    ...
    public function action($what, $cat, &$ret, $limit, $useGlobalCats)
    {
        ...
        if ($useGlobalCats) {
            $categories = [ 'all' => '0', 'movies' => '1', 'tv' => '3', 'music' => '2', 'games' => '4', 'anime' => '9', 'software' => '5', 'pictures' => '8', 'books' => '11' ];
        } else {
