...
{
    public $defaults = [ "public" => false, "page_size" => 50, "cookies" => "scenehd.org|pass=XXX;uid=XXX;" ];
    public $categories = [ 'all' => '', 'Movie/1080' => '&cat=1', 'Movie/720' => '&cat=4', 'Movie/BD5/9' => '&cat=8', 'Movie/Complete' => '&cat=22',
    ...
    public function action($what, $cat, &$ret, $limit, $useGlobalCats)
    {
        ...
        if ($useGlobalCats) {
            $categories = [ 'all' => '', 'movies' => '&cat=1,4,8,22', 'tv' => '&cat=5,7' ];
        } else {
