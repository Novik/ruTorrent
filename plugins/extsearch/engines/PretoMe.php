...
{
    public $defaults = [ "public" => false, "page_size" => 25, "cookies" => "pretome.info|pass=XXX;uid=XXX" ];

    public $categories = [ 'all' => '', 'Applications' => '&cat[]=22', 'Ebooks' => '&cat[]=27', 'Games' => '&cat[]=4',
    ...
    public function action($what, $cat, &$ret, $limit, $useGlobalCats)
    {
        ...
        if ($useGlobalCats) {
            $categories = [ 'all' => '0', 'movies' => '&cat[]=19', 'tv' => '&cat[]=7', 'music' => '&cat[]=6', 'games' => '&cat[]=4', 'software' => '&cat[]=22', 'books' => '&cat[]=27' ];
        } else {
