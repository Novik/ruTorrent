 ...
 theUILang.autotoolsPathToFinished		= "Pad naar finished downloads";
 theUILang.autotoolsEnableWatch		= "Aanzetten \"AutoWatch\" feature";
 theUILang.autotoolsPathToWatch		= "Pad naar basis watch folder";
 ...
 theUILang.autotoolsNoPathToFinished	= "Autotools plugin: pad naar finished download folder is niet ingevuld. " + s_PluginFail;
 theUILang.autotoolsNoPathToWatch		= "Autotools plugin: pad naar base watch folder is niet ingevuld. " + s_PluginFail;
