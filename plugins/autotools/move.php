                        ...
                        while ($path != '' && $path != $path_to_finished) {
                            ...
                            if (is_file($mailto_file)) {
                                ...
                                while (count($lines) > 0) {
                                    ...
                                    if (trim($params[0]) == "TO") {
                                        $mail_to   = trim($params[1]);
                                    } elseif (trim($params[0]) == "CC") {
                                        $mail_cc   = trim($params[1]);
                                    } elseif (trim($params[0]) == "BCC") {
                                        $mail_bcc  = trim($params[1]);
                                    } elseif (trim($params[0]) == "FROM") {
                                        $mail_from = trim($params[1]);
                                    } elseif (trim($params[0]) == "SUBJECT") {
