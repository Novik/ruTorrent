		...
		"<fieldset>"+
			...
			"<tr>"+
				"<td>"+
					...
					"onchange='linked(this, 0, [\"automove_filter\", \"skip_move_for_files\", \"path_to_finished\", \"path_to_finished_btn\", \"fileop_type\", \"auto_add_label\", \"auto_add_name\" ]);' />"+
			...
			"<tr>"+
				"<td colspan=2>"+
					...
					"onchange='linked(this, 0, [\"path_to_watch\", \"path_to_watch_btn\",\"watch_start\"]);' />"+
