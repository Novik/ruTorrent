                    ...
                    if (!$torrent->errors()) {
                        ...
                        if ($eReq->run() && !$eReq->fault) {
                            ...
                            if (!rTorrent::sendTorrent(
                                ...
                                $errors[] = ['desc' => "theUILang.errorAddTorrent", 'prm' => $fname];
                            }
                        } else {
                            $errors[] = ['desc' => "theUILang.badLinkTorTorrent", 'prm' => ''];
                        }
                    } else {
                        $errors[] = ['desc' => "theUILang.errorReadTorrent", 'prm' => $fname];
                    }
                } else {
                    $errors[] = ['desc' => "theUILang.cantFindTorrent", 'prm' => ''];
                }
            } else {
                $errors[] = ['desc' => "theUILang.badLinkTorTorrent", 'prm' => ''];
            }
...
CachedEcho::send(JSON::safeEncode([ "errors" => $errors, "hash" => $hashes ]), "application/json");
