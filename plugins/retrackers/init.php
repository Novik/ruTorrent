...
$req = new rXMLRPCRequest([
    $theSettings->getOnInsertCommand(['tadd_trackers1' . User::getUser(), getCmd('d.set_custom4') . '=$' . getCmd('cat') . '=$' . getCmd('d.get_state=')]),
    $theSettings->getOnInsertCommand(['tadd_trackers2' . User::getUser(),
