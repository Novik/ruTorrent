...
class rScheduler
{
    ...
    public static function setSpeed($ul, $dl)
    {
    ...
    {
        $delta = 2;
        $cmd = new rXMLRPCCommand("d.multicall", ["started",getCmd("d.get_hash="),getCmd("d.get_connection_current=") ]);
        ...
        return(["seeds" => $seeds,"leeches" => $leeches]);
    }
