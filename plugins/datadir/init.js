...
theWebUI.EditDataDir = function()
{
	...
	{
	        var save_path = String.prototype.trim(this.torrents[id].save_path)
...
theWebUI.showDataDirDlg = function( d )
{
	...
	if( id && (id.length==40) && this.torrents[id] )
	{
		is_done = String.prototype.trim(this.torrents[id].done) == 1000;
		is_multy = String.prototype.trim(this.torrents[id].multi_file) != "0";
	}
	$('#edit_datadir').val( String.prototype.trim(d.savepath) );
