 ...
 */
 ...
 theUILang.rssSrcHref		= "If the torrent download URL matches the pattern";
 theUILang.rssSrcGuid		= "If the torrent description URL matches the pattern";
 theUILang.rssDstHref		= "then replace the torrent download URL with";
 theUILang.rssDstGuid		= "then replace the torrent description URL with";
 ...
 theUILang.rssPatternError	= "Error in the pattern string.";
