 ...
 */
 ...
 theUILang.hstDeletePrompt	= "Êtes-vous sûr de vouloir supprimer le(s) enregistrement(s) ?";
 theUILang.hstDelete		= "Supprimer le(s) enregistrement(s)";
 theUILang.Added		= "Ajouté";
 theUILang.Finished		= "Terminé";
