 ...
 */
 ...
 theUILang.BadTorrentData		= "You must fill in all required fields!";
 theUILang.createExternalNotFound	= "Create plugin: The plugin will not work. The web server user can't access an external program";
 theUILang.incorrectDirectory		= "Incorrect directory";
 theUILang.cantExecExternal		= "Can't execute an external program";
 theUILang.createConsole		= "Console";
 theUILang.createErrors			= "Errors";
 theUILang.torrentSave			= "Save";
 theUILang.torrentKill			= "Stop";
 theUILang.torrentKilled		= "The process was stopped.";
