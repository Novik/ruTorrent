 ...
 */
 ...
 Rest_access		: "限制下列 IP 地址的連接(請用 '','' 分隔)",
 ...
 Disc_cahe		: "磁碟快取",
 Disc_cahe_bla_bla	: "磁碟快取的作用是將用戶頻繁要求的資料片段保存在記憶體中，從而減少讀寫磁碟的次數。 rTorrent 通常自動管理緩存，但您可以通過修改以下設定更改其操作模式。",
 Overwr_d_cahe_au	: "手動指定緩存大小以覆蓋自動設置的快取大小",
 MB			: "MB",
 Red_mem_usage		: "不需要快取時減少記憶體的使用量",
 Adv_cache_sett		: "進階快取設定",
 En_cach_disc		: "啟用磁碟寫入快取",
 Wr_out_ever_2_min	: "每 2 分鐘寫入未使用的區塊",
 Wr_immed		: "立即寫入已下載完畢的區塊",
 En_cah_disc_read	: "啟用磁碟讀取快取",
 Turn_off_w_read	: "如果上傳速度較低則關閉讀取快取",
 Rem_old_from_cahe	: "從快取中移除較舊的快取區塊",
 Increase_autom_cach	: "自動增加快取的大小",
 Advanced		: "進階",
