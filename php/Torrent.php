...
class Torrent
{
    ...
    public function setMeta($key, $value)
    {
        $key = (string) $key;
        switch ($key) {
            case 'announce':		$this->announce = $value;
                break;
            case 'comment':			$this->comment = $value;
                break;
            case 'encoding':		$this->encoding = $value;
                break;
            case 'httpseeds':		$this->httpseeds = $value;
                break;
            case 'info':			$this->info = $value;
                break;
            case 'libtorrent_resume':	$this->libtorrent_resume = $value;
                break;
            case 'rtorrent':		$this->rtorrent = $value;
                break;
            default:			$this->extra[$key] = $value;
                break;
        }
    }
     ...
     */
    public function __construct($data, $meta = [], $piece_length = 256, $log_callback = null, $err_callback = null)
    {
        try {
            if (is_string($meta)) {
                $meta =  [ 'announce' => $meta ];
     ...
     */
    private static function encode_dictionary($array)
    {
    ...
    private static function isPathCandidate($value)
    {
