...
class LFS
{
    public static function test($fname, $flag)
    {
        $out = array();
    ...
    protected static function statPrim($fname)
    {
        $out = array();
    ...
    public static function filesize($fname)
    {
        $ss = self::stat($fname);
