...
##Getting started
  ...
  * There's no installation routine or compilation necessary. The sources are cloned/unpacked into a directory which is setup as document root of a web server of your choice (for detailed in struction see the [werserver wiki article](https://github.com/Novik/ruTorrent/wiki/WebSERVER).
